                  ...
                  >
                    {openRows[i] && (
                      <Box sx={{ p: 2, bgcolor: "#0d1117" }}>
                        ...
                        <Typography
                          sx={{ fontWeight: 700, mt: 2, mb: 1, color: "#fff" }}
                        >
                          RADIO 2
                        </Typography>
    ...
    <Table size="small">
      ...
      <TableBody>
        {data.map((s, i) => (
          ...
          >
            <TableCell sx={{ color: "#fff" }}>{s.rfid}</TableCell>

            <TableCell sx={{ color: "#fff" }}>{s.abs_location}</TableCell>
