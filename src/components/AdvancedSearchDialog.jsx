import {
    ...
    Stack, Typography, Divider, Box, ToggleButton, ToggleButtonGroup
} from "@mui/material";
...
export default function AdvancedSearchDialog({
        ...
        ? (locoOptions?.tableType === "station_emergency"
            ? {
                ...
                ? {
                    ...
                    uplink_freq_channel: ["Valid Frequencies", "Reserved", "LTE/4G/5G", "Invalid"],
                    downlink_freq_channel: ["Valid Frequencies", "Reserved", "LTE/4G/5G", "Invalid"],
                }
                : {
                    // ===== COMMON / RADIO =====
                    source_version: ["KAVACH 3.2", "KAVACH 4.0"],
                    ...
                    // ===== MA =====
                    dest_loco_sos: ["No SoS", "Foreign RFID", "Reserved", "SPAD", "Onboard Odo Error ≥120m", "Rear End Collision", "Head On Collision", "Shunting Limit Violation", "Station General SoS",],
                    train_section_type: ["Station Section", "Absolute Block", "Autoblock", "Reserved"],
                    cur_signal_aspect: ["Red", "Yellow", "Green"],
                    next_signal_aspect: ["Red", "Yellow", "Green"],
                    authority_type: ["Unused", "OS Authority", "FS Authority", "SR Authority"],
                    ...
                    auto_whistling_type: ["Distance Based", "Time Based (Not Used)", "Configured Pattern Based (Not Used)", "Spare"],

                    // ===== TAG =====
                    dup_tag_dir: ["Nominal", "Reverse"],

                    // ===== TRACK =====
                    track_condition_type: ["Not Used", "Dead Stop", "Non Stopping Area", "Tunnel Stopping Area", "Sound Horn", "Radio Hole", "Neutral Section", "Reversing Area", "Fouling Mark Location", "KAVACH Territory Exit", "Reserved"],

                    // ===== TSR =====
                    tsr_status: ["No TSR", "Latest TSR Available", "Latest TSR Available", "Reserved"],
    ...
    const filterBySubPacket = (events) => {
        ...
        const map = {
            ma: [
                "authority_type", "authorized_speed", "ma_distance_m",
                "train_section_type", "cur_signal_aspect", "next_signal_aspect"
            ],
            ...
            <DialogContent>
                ...
                <Stack direction="row" spacing={1} mb={1}>
                    <TextField
                        ...
                        placeholder={locoOptions?.isStation ? "Enter Station ID" : "Enter Loco ID"}
                    />
                    <Button onClick={addLoco} variant="contained">Add</Button>
                ...
                {eventType === "dynamic" && (
                    <Stack>
                        ...
                        {/*  ADD THIS BLOCK */}
                        <Stack direction="row" spacing={1} mb={1}>
                            <Button size="small" onClick={() => setSelectedDynamic(dynamicEvents)}>
                                Select All
                            </Button>
