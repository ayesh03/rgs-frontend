    ...
    >
      ...
      >
        <Box>
          ...
          >
            Dashboard{" "}
            <Box component="span" sx={{ color: "#4dabf7", ml: 1 }}>
              Overview
            </Box>
          </Typography>
        </Box>
                    ...
                    <Stack spacing={2.5}>
                      ...
                      <Box>
                        ...
                        <Stack direction="row" spacing={3} sx={{ mt: 1 }}>
                          <Tooltip title="Filter by Loco IDs">
                            <Typography
                              variant="caption"
                          ...
                          <Tooltip title="Filter by Station / Kavach IDs">
                            <Typography
                              variant="caption"
                          ...
                          <Tooltip title="Filter by NMS System IDs">
                            <Typography
                              variant="caption"
      ...
      >
        ...
        >
          ...
          <Tooltip title="Apply selected filter">
            <Button
              variant="contained"
              size="small"
              fullWidth
              ...
              onClick={() => {
                ...
                if (selectorType === "loco") {
                  ...
                  else filterField = "source_loco_id";
                }
