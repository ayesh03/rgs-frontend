...
import { Box, Tabs, Tab, Paper, alpha, useTheme, Tooltip } from "@mui/material";
  ...
  return (
    ...
    >
      <ReportHeader
        ...
        onSearch={(value) => tabRefs[tab]?.current?.searchByHealth?.(value)}
      />
      ...
      >
        ...
        >
          <Tooltip title="View stationary health report">
            <Tab label="Stationary Health" />
          </Tooltip>
          <Tooltip title="View onboard health report">
      ...
      <Box sx={{ mt: 0.1 }}>
        <AnimatePresence mode="wait">
          ...
          >
            {tab === 0 && (
              <StationaryHealth ref={stationaryRef} healthType="STATIONARY" />
            )}
            {tab === 1 && (
              <StationaryHealth ref={onboardRef} healthType="ONBOARD" />
            )}
          </motion.div>
        </AnimatePresence>
      </Box>
